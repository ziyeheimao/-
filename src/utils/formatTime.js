...
const getDateObj = (times) => {
  let time = times;
  let yy = time.getFullYear()
  let mm = add0(time.getMonth() + 1) 
  let dd = add0(time.getDate())
  let day = new Array()
  day[0] = "周日"
  day[1] = "周一"
  day[2] = "周二"
  ...
  day[5] = "周五"
  day[6] = "周六"
  return {yy,mm,dd,day:day[time.getDay()]}
}
const timestampToCommonDate = (timestamp,type) => {
